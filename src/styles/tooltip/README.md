...
```html
<p>
  HTML is related to but different from <span id="xml"><i>XML</i></span
  >.
</p>
...
<span class="mdl-tooltip" for="xml"
  >e<b>X</b>tensible <b>M</b>arkup <b>L</b>anguage</span
>
```
...
<span class="mdl-tooltip" for="xml"
  >XML is an acronym for eXtensible Markup Language</span
>
```
...
<span class="mdl-tooltip mdl-tooltip--large" for="xml"
  >eXtensible Markup Language</span
>
```
...
<span class="mdl-tooltip" for="xml">
  <img src="xml-logo-small.png" width="20" height="10" /> eXtensible Markup
  Language</span
>
```
